...
class PruneConfig:
    ...
    loss_type: str       # "clm" | "gold"

    # gold off-policy distillation loss (used only when loss_type == "gold")
    teacher_model: str   # path to the teacher model
    gold_beta: float
    ...
    def from_yaml(cls, config_path="config/prune_config.yaml"):
        ...
        return cls(
            ...
            loss_type=str(cfg.get("loss_type", "clm")).lower(),
            teacher_model=str(cfg.get("teacher_model", "")),
